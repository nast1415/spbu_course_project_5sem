...
This dataframe includes columns:
	...
	-action
'''
waypoint_info = pd.read_csv("primary_data/delta4_training_matrix.csv")
...
with open('find_nearest_station/result_nearest') as inp:
...
waypoint_info.to_csv("find_nearest_station/training_with_nearest.csv")
